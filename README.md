...
`javascript:(function(){$.getScript('https://rawgit.com/DarkBot/source/master/basicBot.js');})();`

If this does not work, go to https://rawgit.com/DarkBot/source/master/basicBot.js and copy paste its content into your console (accessible in chrome by pressing F12) when on plug.dj in your community.
