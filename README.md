...
`javascript:(function(){$.getScript('https://github.com/Darkmaster0270/BasicBot/blob/master/basicBot.js');})();`

If this does not work, go to https://github.com/Darkmaster0270/BasicBot/blob/master/basicBot.js and copy paste its content into your console (accessible in chrome by pressing F12) when on plug.dj in your community.
